...
//        if (Aesthetic.isFirstTime()) {
            Aesthetic.get()
                    ...
                    .textColorPrimaryRes(R.color.md_white)
                    .textColorSecondaryRes(R.color.md_light_text_87)
                    .colorPrimaryRes(R.color.md_green_500)
                    .colorAccentRes(R.color.md_deep_orange_A400)
                    .colorStatusBarAuto()
